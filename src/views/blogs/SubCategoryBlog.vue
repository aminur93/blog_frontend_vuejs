        ...
        <v-container class="my-5">
            <v-row>
                ...
                <v-col cols="8">
                    ...
                    >
                        No Data Found On This Sub Category
                    </v-alert>
...
<script>
    ...
    export default {
        ...
        watch: {
            $route() {
                this.getSubCategoryBlog(this.$route.params.sub_cat_id);
            }
        },
        ...
        methods: {
            ...mapActions({
                ...
                getSubCategoryBlog: 'SubCategoryBlog',
            }),

            onPageChange() {
                this.getSubCategoryBlog();
            },
